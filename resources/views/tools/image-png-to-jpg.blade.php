...
@push('setTitle') PNG to JPG @endpush

@push('addTitle'){{ 'Convert PNG to JPG' }}@endpush
    ...
    <div class="max-w-4xl mx-auto px-4 py-8">
        <div class="bg-white rounded-xl p-6">
            ...
            <div class="bg-slate-100 p-8 rounded-2xl border w-full max-w-xl mx-auto">
                <h2 class="text-3xl font-bold mb-6 text-gray-800 text-center">Convert PNG to JPG</h2>
                ...
                <form method="POST" action="{{ route('tools.convertPngToJpg') }}" enctype="multipart/form-data" class="space-y-6" id="submitForm">
                    @csrf
                    <!-- Image Upload -->
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Choose Image</label>
                        <input type="file" name="image" class="w-full border border-gray-300 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500" accept="image/png">
                    </div>
