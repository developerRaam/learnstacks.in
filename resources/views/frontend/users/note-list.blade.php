                    ...
                    <div class="card p-3 bg-light">
                        <table class="table table-striped table-hover">
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a class="btn btn-primary btn-sm" href="{{ route('frontend.note.edit', $note->id) }}">
                                                    <i class="lni lni-pencil-1"></i>
                                                </a>
                                                <form action="{{ route('frontend.note.destroy', $note->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit" class="btn btn-danger btn-sm deleteRow" data-name="{{ $note->name }}" data-row-name="Post" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Delete">
                                ...
                                @empty
                                    <caption class="text-center">Not created any chapter</caption>
                                @endforelse
                            </tbody>
                        </table>
                        <!-- Pagination -->
